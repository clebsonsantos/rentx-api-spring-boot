...
insert into cars (about, brand, created_at, fuel_type, id, name, period, price, thumbnail, updated_at) values 
    ('O carro ainda tem sistema de tração nas quatro rodas Quattro com diferencial traseiro esportivo de série. De acordo com a Audi, ele faz o mesmo em 3,8 segundos na Sportback.', 'Audi', 1623015841136, 'electric_motor', '535e8de8-721b-4bac-8b72-7d29be7da467', 'RS 5 Coupé', 'Ao dia', 120, 'https://storage.googleapis.com/golden-wind/ignite/react-native/thumbnails/1.png', 1647516412357),
    ('O Panamera é um automóvel de luxo coupé com porte grande. Tem motorização dianteira V6 e V8. A tração é integral com uma caixa PDK de sete mudanças e dupla embreagem.', 'Porsche', 1623015841136, 'gasoline_motor', 'ffb71f55-818a-48b1-b7d2-2efc406ede25', 'Carro do Batman', 'Ao dia', 340, 'https://storage.googleapis.com/golden-wind/ignite/react-native/thumbnails/2.png', 1623015841136),
    ('O Chevrolet Corvette Z06 inclui freios Brembo de alto desempenho com pinças maiores no conjunto dianteiro, itens aerodinâmicos com capô de fibra de carbono, suspensão para alto desempenho.', 'Chevrolet', 1623015841136, 'gasoline_motor', '52930821-cbea-4b05-9f45-7c02b1bb0d8c', 'Camaro Amarelo', 'Ao dia', 620, 'https://storage.googleapis.com/golden-wind/ignite/react-native/thumbnails/3.png', 1623015841136),
    ('Este é automóvel desportivo. Surgiu do lendário touro de lide indultado na praça Real Maestranza de Sevilla. É um belíssimo carro para quem gosta de acelerar.', 'Lamborghini', 1623015841136, 'electric_motor', '49983f6c-a46a-4dfd-a86e-425b8c72e086', 'Huracan', 'Ao dia', 120, 'https://storage.googleapis.com/golden-wind/ignite/react-native/thumbnails/4.png', '2022-03-12 12:43:53'),
    ('A Poderosa Combinação de um Motor Elétrico de Alto Desempenho e um Motor a Combustão. Compacto e Inovador. Com Design Expressivo, Tecnologias Intuitivas e Estilo Urbano.', 'volvo', 1623015841136, 'gasoline_motor', '508e7193-0078-4615-9071-920b59038fda', 'XC40', 'Ao dia', 120, 'https://storage.googleapis.com/golden-wind/ignite/react-native/thumbnails/5.png', 1623015841136),
    ('Mitsubishi Lancer é um belo e agressivo carro. Além do mais, ele encanta pelo conforto e pela eficiência. Bastante firme e estável para dirigir com tranquilidade e segurança.', 'mitsubishi', 1623015841136, 'hybrid_motor', '59626707-88c5-4877-9350-07f372c0905a', 'Lancer', 'Ao dia', 220, 'https://storage.googleapis.com/golden-wind/ignite/react-native/thumbnails/6.png', 1623015841136);

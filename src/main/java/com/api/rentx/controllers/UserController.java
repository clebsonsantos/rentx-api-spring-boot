...
import com.api.rentx.dtos.PasswordDTO;
...
public class UserController {
  ...
  @PostMapping("/sync")
  public ResponseEntity<Object> syncUser(@RequestBody UserDTO user) {
    return ResponseEntity.status(HttpStatus.OK).body("Metodo não implementado");
  }

  @PutMapping
  public ResponseEntity<Object> updatePassword(@RequestBody PasswordDTO password) {
    return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Metodo não implementado");
  }
}
